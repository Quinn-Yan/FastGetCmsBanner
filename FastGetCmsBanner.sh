...
which "wget" > /dev/null
if [ $? -eq 0 ];then
    echo -e "\033[32m\nWget is Installed !\033[0m"
    which "curl" > /dev/null
    if [ $? -eq 0 ];then
        echo -e "\033[32mCurl is Installed  !\033[0m"
    else
        apt-get install curl -y
        if [ $? -eq 0 ];then
            echo -e "\033[32mCurl install Succeed !\033[0m\n"
        else
            echo -e "\033[32mCurl Install Failed! Plese Check!\033[0m\n"
            exit
        fi
    fi
    ...
    if [ $? -eq 0 ];then
        ...
        echo -e "\033[32mWget Install Failed! Plese Check!\033[0m\n"
        exit
    fi
fi
